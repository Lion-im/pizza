  ...
  <body>
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            $query_pizza = mysqli_query($con, "SELECT * FROM pizza");
            $query_zakaz = mysqli_query($con, "SELECT * FROM zakaz");

            $visible = "none";

            while($zakaz = $query_zakaz->fetch_assoc()){
            ?>
                <div class="row">
                    <div class="col-3">
           ...
           <?php } ?>
                ...
                <div style="display: flex;">
                    ...
                    <form action="deleteAll.php" method="GET">
                        <button class="btn bg-btn-dodo cls my-3" style="margin-left: 10px; display: 
                        <?php if ($query_zakaz->num_rows == 0){
                            echo "none";
                        } else{
                            echo "block";
                        }
        ...
        <div class="row pb-5">
            ...
            while($pizza = $query_pizza->fetch_assoc()){
            ...
            <div class="col-3">   
                ...
                <div class="pizz"> 
                    ...
                    <p class="text-secondary"><?php echo $pizza["text"] ?></p>
                </div>  
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <form action="insert.php" method="GET">
                            <input type="hidden" name="title" value="<?php echo $pizza["title"] ?>">
                            <input type="hidden" name="image" value="<?php echo $pizza["img"] ?>">
